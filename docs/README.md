...
- [项目概览（中文默认）](../README.md)：产品定位、快速开始、目录结构和验证入口。
- [项目概览（英文）](../README.en.md)：英文版本的项目概览。
- [项目概览（中文兼容入口）](../README.zh-CN.md)：保留给旧链接使用的中文入口。
...
- [发版清单](RELEASE_CHECKLIST.md)：每次发版固定流程、双渠道发布门禁、打包命令、自动化与人工验收项。
- [重构交接（2026-09-13）](REFACTOR_HANDOFF_2026-09-13.md)：本轮重构范围、数据兼容保证、验证结果、未完成项和接手建议。
...
- 用户操作变化更新 `README.md`、`README.en.md`、`README.zh-CN.md` 和 `docs/USER_GUIDE.md`。
